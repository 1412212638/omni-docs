...
<div class="home-section">
  ...
  <h2>Quickly locate the OmniRouters capability area you need</h2>
  <div class="home-grid home-grid-3">
    <div class="home-card">
      <h3>Chat and generation</h3>
      <p>Entry points for chat, completion, and common multi-model generation workflows.</p>
    </div>
    <div class="home-card">
      <h3>Image and video</h3>
      <p>Browse multimodal capability directories such as image and video by scenario.</p>
    </div>
    <div class="home-card">
      <h3>Audio and vectors</h3>
      <p>Find documentation for audio, embeddings, rerank, and other extended capabilities.</p>
    </div>
  </div>
</div>
...
<div class="home-section">
  ...
  <div class="home-flow">
    <div class="home-flow-item">
      <span>01</span>
      <strong>Start with the API</strong>
      <p>Use the API page to identify the capability area and endpoint family you need.</p>
    </div>
    <div class="home-flow-item">
      <span>02</span>
      <strong>Escalate to support</strong>
      <p>Send technical issues to support@omnirouters.com so we can investigate and help quickly.</p>
    </div>
    <div class="home-flow-item">
      <span>03</span>
